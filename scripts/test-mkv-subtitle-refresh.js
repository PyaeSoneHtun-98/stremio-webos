...
assert(source.includes('__sbFallbackEnd - 8'),'refresh must begin before the previous cue window expires');
console.log('PASS: MKV cue refresh keeps last-good cues, retries quickly, and prefetches before expiry');
